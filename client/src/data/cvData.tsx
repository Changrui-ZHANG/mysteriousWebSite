...
import { FaReact, FaJava, FaPython, FaDocker, FaLinux, FaGitAlt, FaJenkins, FaWindows, FaUniversity, FaServer, FaDatabase } from "react-icons/fa";
...
export const getCVData = (t: (key: string, options?: any) => any) => {
