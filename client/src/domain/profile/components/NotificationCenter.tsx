...
const NotificationItem: React.FC<NotificationItemProps> = ({ notification, onRemove }) => {
    ...
    return (
        <div className={`max-w-sm w-full ${getBgColor()} border rounded-lg shadow-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden`}>
            <div className="p-4">
...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({
    ...
    return (
        <div
            className={`fixed ${getPositionClasses()} z-50 flex flex-col space-y-4 pointer-events-none ${className}`}
            aria-live="assertive"
        >
